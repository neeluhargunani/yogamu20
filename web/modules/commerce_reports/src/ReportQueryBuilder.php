...
class ReportQueryBuilder {
  ...
  /**
   * Commerce order report storage.
   *
   * @var \Drupal\Core\Entity\EntityStorageInterface
   */
  protected $commerceOrderReportStorage;
  ...
  public function __construct(EntityTypeManagerInterface $entity_type_manager) {
    $this->commerceOrderReportStorage = $entity_type_manager->getStorage('commerce_order_report');
  }
  ...
  public function getQuery(ReportTypeInterface $report_type, $date_format = 'F Y') {
    $query = $this->commerceOrderReportStorage->getAggregateQuery();
